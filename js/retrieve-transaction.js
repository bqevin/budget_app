...
myDataRef.onAuth(function(authData) {
    if (authData) {
        ...
        ref.on("child_added", function(snapshot, prevChildKey) {
            ...
            $('<a  class="list-group-item"><ul class="no-bullets"><li><b>Transaction Date:</b> ' + newTrans.trans_date + '<li><b>Payee:</b> ' + newTrans.payee + '</li>' + '<li><b>Transaction Amount:</b> ' + newTrans.trans_amount + '</li>' + '<li><b>Transaction Type:</b> ' + (newTrans.trans_type).replace("_"," & ") + '</li>' + '<li><b>Transaction Notes:</b> ' + newTrans.trans_desc + '</li></ul></a>').appendTo($('#your-transactions'));
